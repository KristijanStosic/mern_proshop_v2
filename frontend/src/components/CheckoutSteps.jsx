...
const CheckoutSteps = ({ step1, step2, step3, step4 }) => {
    return (
        <ol
            ...
            "
        >
            <li className={`${step1 ? "text-slate-700" : ""}`}>
                <span className="inline-flex items-center gap-1"><FaTruck size={20} />Shipping</span>
            </li>

            <li className={`${step2 ? "text-slate-700" : ""}`}>
                <span className="inline-flex items-center gap-1"><MdPayment size={20} /> Payment</span>
            </li>

            <li className={`${step3 ? "text-slate-700" : ""}`}>
